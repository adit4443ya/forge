...
export const TIERS = [
  ...
  },
  {
    ...
    groups: [
      ...
      { pattern: "Elite: reduction & search", ids: [126, 127] },
      { pattern: "Elite: greedy proofs",      ids: [124] },
      { pattern: "Elite: streaming sketches", ids: [125] },
      { pattern: "Elite: systems design",     ids: [123, 128] },
