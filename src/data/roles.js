...
export const ROLES = [
  {
    ...
    competencies: [
      { id: "c-ir", name: "Read and reason about IR", level: "foundation",
        ...
        guides: ["01", "02", "11"], modules: ["ssa", "llvm", "passes"], labs: ["ir-", "xl-"], sections: ["Graph — BFS", "Graph — Topo Sort", "Tree"] },
      ...
      { id: "c-backend", name: "Backend: selection, allocation, scheduling", level: "working",
        ...
        guides: ["03", "04", "13", "15"], modules: ["isel", "regalloc", "pipeline"], labs: ["aarch64-01"], sections: ["Graph — Union Find", "Greedy", "Heap"] },
      { id: "c-vec", name: "Vectorization and cost models", level: "expert",
        ...
        guides: ["02", "14"], modules: ["vec", "alias", "dataflow"], labs: ["codegen-02", "aarch64-02"], sections: ["DP — Sequence", "Math", "Prefix Sums"] },
      { id: "c-arch", name: "Target architecture depth", level: "expert",
        ...
        guides: ["13", "14", "15", "19"], modules: ["arm", "arch"], labs: ["aarch64-"], sections: ["Bit Manipulation", "Math"] },
  ...
  },
  {
    ...
    competencies: [
      { id: "s-measure", name: "Measurement discipline", level: "foundation",
        ...
        guides: ["20"], modules: ["arch"], labs: ["perf-01", "perf-04"], sections: ["Math", "Randomized"] },
      { id: "s-profile", name: "Profiling to a line", level: "foundation",
        ...
        guides: ["20", "21"], modules: ["test"], labs: ["perf-02", "perf-03", "bigcode-04"], sections: ["Heap", "Quickselect", "HashMap"] },
      { id: "s-memory", name: "Memory hierarchy", level: "working",
        ...
        guides: ["19"], modules: ["arch"], labs: ["cache-"], sections: ["Matrix", "Two Pointers", "Prefix Sums"] },
      { id: "s-uarch", name: "Microarchitecture", level: "working",
        ...
        guides: ["19"], modules: ["arch", "vec"], labs: ["codegen-03", "codegen-04", "perf-02"], sections: ["Bit Manipulation", "Monotonic Stack"] },
      { id: "s-kernel", name: "OS behaviour and tails", level: "expert",
        ...
        guides: ["17"], modules: ["arch"], labs: ["perf-05", "systems-"], sections: ["Design", "System Design DSA"] },
      { id: "s-prove", name: "Turn a finding into a decision", level: "expert",
        ...
        guides: ["20"], modules: [], labs: ["capstone-"], sections: ["Intervals", "Segment Tree"] },
    ],
  },
  {
    id: "hft",
    ...
    competencies: [
      { id: "h-cpp", name: "C++ that survives the hot path", level: "foundation",
        ...
        guides: ["05", "06", "16"], modules: ["cpp_obj", "cpp_tpl", "cpp_mem", "cpp_misc"], labs: ["codegen-01", "codegen-05"], sections: ["Design", "Linked List"] },
      { id: "h-latency", name: "Latency thinking", level: "foundation",
        ...
        guides: ["17", "18"], modules: ["hft"], labs: ["perf-05", "systems-02", "systems-03"], sections: ["Sliding Window", "Heap"] },
      { id: "h-conc", name: "Concurrency without locks", level: "working",
        ...
        guides: ["07", "19"], modules: ["cpp_con"], labs: ["concurrency-"], sections: ["Design", "System Design DSA"] },
      ...
      { id: "h-net", name: "Networking and the kernel boundary", level: "expert",
        ...
        guides: ["18", "17"], modules: ["hft"], labs: ["systems-03", "systems-04", "systems-05"], sections: ["String Parsing", "Intervals"] },
      { id: "h-box", name: "Own the machine", level: "expert",
        ...
        guides: ["17"], modules: [], labs: ["perf-05", "cache-06"], sections: ["Greedy"] },
      ...
      { id: "h-num", name: "Numerical care and reproducibility", level: "expert",
        ...
        guides: ["02", "19"], modules: ["cpp_con"], labs: ["codegen-02", "cache-03", "concurrency-01"], sections: ["Math", "Bit Manipulation"] },
    ],
  },
];
