...
export const ROLES = [
  ...
  },
  {
    ...
    tag: "tick-to-trade · C++ · kernel bypass",
    icon: "⚡",
    hue: "warn",
    reality:
  ...
  },
  {
    ...
    tag: "probability · numerics · microstructure",
    icon: "∑",
    hue: "info",
    reality:
      "You sit between research and production. A researcher's idea arrives as a notebook and has to become something that runs correctly, fast, and identically every time. The interview screens for clean probabilistic reasoning and fast, correct code; the job asks for numerical care, reproducibility, and enough market structure to know when a result is an artifact.",
    day: [
      "Turn a research prototype into production code without changing its answers",
      "Reason about an expectation or a conditional probability out loud, correctly",
      "Notice that a backtest result is an artifact of look-ahead or survivorship",
      "Make a simulation deterministic and fast enough to run a thousand times",
      "Explain a numerical difference between two implementations to a researcher",
    ],
    competencies: [
      { id: "q-prob", name: "Probability under pressure", level: "foundation",
        doing: "Expectation, conditioning, symmetry, linearity. You reach for the right one in ninety seconds.",
        signal: "Classic setups: coins, dice, urns, random walks, expected waiting times.",
        guides: [], modules: ["quant_prob"], labs: [], sections: ["Randomized", "Math"] },
      { id: "q-code", name: "Correct code, fast", level: "foundation",
        doing: "Clean implementations under a clock, with the invariant stated before the code.",
        signal: "The same coding bar as any strong loop, with less tolerance for hand-waving.",
        guides: [], modules: [], labs: [], sections: ["Math", "Bit Manipulation", "Randomized"] },
      { id: "q-num", name: "Numerical care", level: "working",
        doing: "Floating-point error, reassociation, stability, and knowing when a difference is real.",
        signal: "Two implementations disagree in the seventh digit. Which is right, and does it matter?",
        guides: ["02", "19"], modules: [], labs: ["codegen-02", "cache-03"], sections: [] },
      { id: "q-micro", name: "Market microstructure basics", level: "working",
        doing: "Order types, the book, spread and depth, adverse selection, why latency has value.",
        signal: "Why does a market maker care about queue position?",
        guides: ["18", "22"], modules: ["quant_micro"], labs: [], sections: ["HFT Structures"] },
      { id: "q-repro", name: "Reproducibility", level: "expert",
        doing: "Seeded randomness, deterministic parallelism, and pipelines that give the same answer twice.",
        signal: "How do you make a parallel simulation reproducible without making it serial?",
        guides: ["22"], modules: ["cpp_con"], labs: ["concurrency-01"], sections: [] },
    ],
  },
];
